...
def train_and_save_svr():
    ...
    model_path = os.path.join(base_dir, "svr_model.pkl")
    scaler_path = os.path.join(base_dir, "svr_scaler.pkl")
    metrics_path = os.path.join(base_dir, "svr_metrics.json")
